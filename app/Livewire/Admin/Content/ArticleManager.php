...
class ArticleManager extends Component
{
    ...
    public string $type = 'news'; // default
    ...
    public function save(CmsRepository $repo)
    {
        ...
        $data = [
            ...
            'type' => ArticleType::tryFrom($this->type) ?? ArticleType::News,
        ...
        if ($this->isEditMode) {
            ...
            unset($data['slug']);
            $article->update($data);
            $this->noticeMessage = "Artikel berhasil diperbarui!";
        } else {
            $article = Article::create($data);
            $this->noticeMessage = "Artikel berhasil diterbitkan!";
        }
    ...
    public function render()
    {
        ...
        return view('livewire.admin.content.article-manager', [
            'articles' => $articles
        ]);
    }
}
